(function (global, factory) {
...
}(this, (function (exports, _angular_core, _angular_common, intlTelInput, _angular_forms) {
    'use strict';
    ...
    var NgxPhoneSelectDirective = (function () {
        ...
        NgxPhoneSelectDirective.prototype.getNumberE164 = function () {
            return $(this.el.nativeElement).intlTelInput('getNumber', intlTelInputUtils.numberFormat.E164);
        };
        /**
         * @return {?}
         */
     ...
     * @nocollapse
     */
    NgxPhoneSelectDirective.ctorParameters = function () {
        return [
